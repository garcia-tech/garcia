...
namespace Garcia.Persistence.ORM
{
    public class GarciaRepository
    {
            ...
            where T : Entity<long>
        {
            ...
            var sql = new GarciaStringBuilder("select * from ");
            var values = new GarciaStringBuilder();
        ...
        {
            var sb = new GarciaStringBuilder("update ");
        ...
        private string GenerateInsertScript(Entity<long> item)
        {
            ...
            var sb = new GarciaStringBuilder(_databaseConnection.BeginTranSqlStatement);
            sb += "insert into ";
            string entityTypeName = this.GetTypeName(item);
            //sb += ColumnPrefix;
            sb += entityTypeName;
            //sb += ColumnPpostfix;
            sb += " (";
            var propertyNames = new GarciaStringBuilder();
            var values = new GarciaStringBuilder();
        ...
        internal virtual Dictionary<string, object> GetParameters(Entity<long> t)
        {
            ...
            foreach (PropertyInfo propertyInfo in properties)
            {
                ...
                var builder = new GarciaStringBuilder("@");
